                  ...
                  <div class="table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <datatable-single :row="entry" field="brand.name">
                          </datatable-single>
                        </td>
                      </tr>
                    </tbody>
...
export default {
  ...
  computed: {
    ...mapGetters('DevicesSingle', ['entry'])
  },
  watch: {
    '$route.params.id': {
      immediate: true,
  ...
  methods: {
    ...mapActions('DevicesSingle', ['fetchShowData', 'resetState'])
  }
}
</script>
